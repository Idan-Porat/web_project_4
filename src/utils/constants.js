...
export const openEditAvatarPopupBtn = document.querySelector('.avatar__edit');

export const editPopupAvatar = document.querySelector(".popup_theme_edit-avatar");
export const elementSelectorTemplate = "#elements__template";
